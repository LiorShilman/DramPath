...
בערכה) בצד שמאל של שורת הבית, ואחריו סנר/בס-דראם/טום-רצפה. טום-גבוה/טום-אמצעי/
רייד יושבים על U/I/O — כולם תחת היד הימנית — במקום R/T/U (שחוצה מהיד השמאלית
לימנית), כדי שניגון הרצף הזה לא ידרוש הצלבה בין הידיים; קראש (E) נשאר לבדו על
היד השמאלית, בהנחה שהוא מנוגן לעיתים רחוקות יותר בהשוואה.
