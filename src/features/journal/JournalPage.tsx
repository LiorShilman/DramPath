...
import type { Exercise, PracticeEntry, PracticeSession } from '../../domain'
...
function SessionRow({ session, entries, exercisesById, onUpdated, onDeleted }: SessionRowProps) {
...
export function JournalPage() {
  ...
  useEffect(() => {
    async function load() {
      const [allSessions, allEntries, allExercises] = await Promise.all([
